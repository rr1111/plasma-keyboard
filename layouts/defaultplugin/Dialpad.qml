...
KeyboardLayout {
    ...
    KeyboardColumn {
        ...
        KeyboardRow { Key { key: Qt.Key_1; text: "1" } Key { key: Qt.Key_2; text: "2" } Key { key: Qt.Key_3; text: "3" } BackspaceKey {} }
        ...
        KeyboardRow { Key { key: Qt.Key_7; text: "7" } Key { key: Qt.Key_8; text: "8" } Key { key: Qt.Key_9; text: "9" } HideKeyboardKey { visible: true } }
        KeyboardRow { Key { key: Qt.Key_Asterisk; text: "*"; alternativeKeys: "*+" } Key { key: Qt.Key_0; text: "0" } Key { text: "#"; key: Qt.Key_NumberSign } EnterKey {} }
    }
}
