...
$XGETTEXT $(find . -name \*.cpp -o -name \*.h) -o "$podir"/plasma-keyboard-virtualkeyboard.pot
...
$XGETTEXT --join-existing --language=JavaScript $(find . -name \*.qml -o -name \*.js) -o "$podir"/plasma-keyboard-virtualkeyboard.pot
